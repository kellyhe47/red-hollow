...
Build **The Red Hollow**: a 1–4 player co-op wave-defense game in **Unity** (top-down, WASD + mouse-aim, LoL-style ability kits) defending an underground Mars colony across 10 monster waves. The spec is complete and review-verified; you need no artifact outside this repo.
