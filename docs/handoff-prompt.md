...
Build **The Red Hollow**: a 1–4 player co-op wave-defense game in **Unity** (tilted isometric 3D top-down, ~60–70° down, WASD + mouse-aim, LoL-style ability kits) defending a terraformed underground Mars colony (Lykos) across 10 monster waves. Western look is on the **heroes**, not the cavern. The spec is complete and review-verified; you need no artifact outside this repo.
