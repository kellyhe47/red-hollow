...
- Turnaround sheets lock identity (and serve marketing). They are not a 3D-model brief and not an 8-dir cycle brief.
- The engine card uses the **canon full-body** (front 3/4). Portraits stay HUD/lobby.
...
Monsters (virus-mutated colonists/livestock, zombie-western horror, readable as a single camera-facing upright card at tilted-isometric distance):
